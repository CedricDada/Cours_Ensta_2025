...
\begin{table}[ht]
  ...
  \addlegendentry{Speedup Maitre esclave mesuré}
  \end{axis}
  \end{tikzpicture}
  \caption{Speedup mesuré (base = 1 processus, temps séquentiel = 3,261~s).}
  \label{fig:speedup_slave}
  \end{figure}
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \addlegendentry{Speedup (1.3)}
    \end{axis}
  \end{tikzpicture}
  \caption{Comparaison des différents speedup}
  \label{fig:speedups}
\end{figure}
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \addlegendentry{Déséquilibrage (1.1)}
    ...
    \addlegendentry{Déséquilibrage (1.2)}
  ...
  \addlegendentry{Déséquilibrage (1.3)}

    \end{axis}
  \end{tikzpicture}
  \caption{Comparaison des différents Déséquilibrages en fonction du nombre de processus.}
  \label{fig:desequilibres}
\end{figure}
\clearpage
